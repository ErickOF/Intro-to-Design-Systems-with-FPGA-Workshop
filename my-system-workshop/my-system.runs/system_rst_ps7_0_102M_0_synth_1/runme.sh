...
HD_PWD='/home/erickof/Documentos/Git/Intro-to-Design-Systems-with-FPGA-Workshop/my-system/my-system.runs/system_rst_ps7_0_102M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_102M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_102M_0.tcl
